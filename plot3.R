...
# Making Plot 3
png (file = "plot3.png")  # Open png device, and create "plot3.png" in my wd

# Create the plot and send it to a file
with (twodaysPower, plot (date_time, Sub_metering_1, type = "s", 
                          xlab = "", ylab = "Energy sub metering")) 
lines (twodaysPower$date_time, twodaysPower$Sub_metering_2, type = "s",
       col = "red")
lines (twodaysPower$date_time, twodaysPower$Sub_metering_3, type = "s",
       col = "blue")
